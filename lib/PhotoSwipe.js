  ...
  _createClass(PhotoSwipe, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          downloadButtonFunction = _props.downloadButtonFunction;
...
PhotoSwipe.propTypes = {
  ...
  downloadButtonFunction: _propTypes2.default.func
};
PhotoSwipe.defaultProps = {
  ...
  className: '',
  downloadButton: null,
  downloadButtonFunction: function downloadButtonFunction() {
