...
PhotoSwipe.propTypes = {
  ...
  downloadButton: _propTypes2.default.element,
  shopButton: _propTypes2.default.element,
  customButtons: _propTypes2.default.element
};
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.openPhotoSwipe = function (props) {
    ...
    _this3.setState({
      ...
      if (options.photoswipeInstance) {
        options.photoswipeInstance(_this3.photoSwipe);
      }
    });
  };
  ...
  this.updateItems = function () {
    ...
    if (_this3.photoSwipe && _this3.photoSwipe.items && items.length !== _this3.photoSwipe.items.length) {
      var currentIndex = _this3.photoswipe.getCurrentIndex();
      ...
      if (currentIndex >= 0 && currentIndex >= items.length) {
        _this3.photoSwipe.goTo(currentIndex - 1);
      }
    }
  };
